...
**Tag** vX.Y.Z
**Commit** <full sha of the commit the installer was built from>
...
MW-11 must carry measured p50 and p95 numbers.
...
| MW-06 | | p50 _ s, p95 _ s over 20 turns |
...
| MW-11 | | p50 _ s, p95 _ s over 20 turns |
| MW-12 | | NOTED is the expected outcome: it confirms ADR-021, it cannot fail the release |
