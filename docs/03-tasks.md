...
**Defects found by the Codex review on the pull request, all three verified and
fixed.** Two P1 and one P2. The first is the one this task's own acceptance
criteria are built around, and neither of the two reviews before it caught it.
